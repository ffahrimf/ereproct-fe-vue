...
defineProps({
  title: { type: String, default: "Title Menu" },
  subtitle: { type: String, default: "Subitle Menu" },
  icon: { type: String, default: "computer-desktop" },
  iconType: { type: String, default: "heroicon" },
