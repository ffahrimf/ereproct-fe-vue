<template>
  ...
  <transition>
    <div
      v-if="isOpen"
      ref="target"
      class="z-50 rounded absolute shadow border bg-white elevation border-gray-200"
    ...
    >
      ...
      <div
        class="z-[51] relative bg-white p-1 rounded max-h-[300px] overflow-y-auto styled-scroll"
        ref="menuRef"
      >
