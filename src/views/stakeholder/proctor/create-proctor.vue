  ...
  <h-dialog :dialog="dialog">
    ...
    >
      <div class="py-2 px-6 border-b flex items-center justify-between">
        <p class="font-medium text-slate-700 text-sm">Create Proctor</p>
...
const form = reactive<CreateProctor>({
  id: "",
  name: "",
  username: "",
  password: "",
...
const postData = (): void => {
  ...
  const req = {
    path: `proctor/${uuid.value ? "update" : "create"}`,
    body: formData
  };
